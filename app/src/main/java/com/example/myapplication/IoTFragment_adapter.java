...
//import com.example.myapplication.category_contents.family.category_contents_family_adapter;
...
//
//public class IoTFragment_adapter {
//
//    public interface OnItemClickListener {
//        public void onItemClick(View view, int position);
//    }
//
//    private category_contents_family_adapter.OnItemClickListener onItemClickListener;
//    private ArrayList<category_user> arrayList; //아까 만든 class에서의 User
//    private Context context;
//
//    public IoTFragment_adapter(ArrayList<category_user> arrayList, Context context, category_contents_family_adapter.OnItemClickListener onItemClickListener) {
...
//    @NonNull
//    @Override
//    public category_contents_family_adapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item1, parent, false);
//        IoTFragment_adapter.CustomViewHolder holder = new IoTFragment_adapter.CustomViewHolder(view);
//        return holder;
//    } //adapter에 연결이 되고난 후 viewholder를 최초로 만들어 낸다.
//
//    @Override
//    public void onBindViewHolder(@NonNull final category_contents_family_adapter.CustomViewHolder holder, final int position) {
